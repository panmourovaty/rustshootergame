/// Shared client library — used by the desktop/WASM binary and the Android
/// shared library.  The `#[bevy_main]` attribute generates the platform-
/// specific entry point: `android_main` on Android, a plain `fn main` wrapper
